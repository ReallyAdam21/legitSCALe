...
<!-- Activity Details -->
        ...
        <table>
            <tr>
                <th><input type="checkbox" name="outcome1" id ="outcome1" value="1"<?php echo ($outcome1 == 1) ? 'checked' : ''; ?>> Increased awareness of strengths</th>
            </tr>
            <tr>
                <th><input type="checkbox" name="outcome2" id ="outcome2" value="1"<?php echo ($outcome2 == 1) ? 'checked' : ''; ?>> Undertaken new challenges</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome3" id ="outcome3" value="1"<?php echo ($outcome3 == 1) ? 'checked' : ''; ?>> Introduced and managed activities</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome4" id ="outcome4" value="1"<?php echo ($outcome4 == 1) ? 'checked' : ''; ?>> Contributed actively in group activities</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome5" id ="outcome5" value="1"<?php echo ($outcome5 == 1) ? 'checked' : ''; ?>> Demonstrated perseverance and commitment in their activities</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome6" id ="outcome6" value="1"<?php echo ($outcome6 == 1) ? 'checked' : ''; ?>> Engaged with issues of global importance</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome7" id ="outcome7" value="1"<?php echo ($outcome7 == 1) ? 'checked' : ''; ?>> Reflected on the ethical consequence of their actions</th>
            </tr>
			<tr>
                <th><input type="checkbox" name="outcome8" id ="outcome8" value="1"<?php echo ($outcome8 == 1) ? 'checked' : ''; ?>> Developed new skills</th>
            </tr>
        </table>
