...
WHERE 
    users_tbl.u_id=".$query_string_id.
...
$info = $result->fetch_assoc();
if ($info) {
    $studlname = $info['u_lname'];
    $studmname = $info['u_mname'];
    $studfname = $info['u_fname'];
}
...
$adviserName = htmlspecialchars($lname . ", " . $fname . " " . $mname);
// Fetch student's name
$studentName = htmlspecialchars($studlname . ", " . $studfname . " " . $studmname);
    ...
    <div class="landscape">
        <div class="form-container">
            ...
            <form>
                ...
                <input disabled type="text" name= "Campus" id="campus" class="input-field"><br><br>

                <label for="studentName">Name of Student:</label>
                <input disabled type="text" name= "studentName" id="studentName" class="input-field" value="<?php echo strtoupper($studentName) ?>"><br><br>

                <label for="batch">Batch:</label>
                <input disabled type="text" name= "batch" id="batch" class="input-field" value ="<?php echo $batch ?> "><br><br>

                <label for="adviserName">Name of Adviser:</label>
                <input disabled type="text" name="adviserName" id="adviserName" class="input-field" value="<?php echo strtoupper($adviserName) ?>"><br><br>
                <label for="evidence">Attached Evidence:</label>
                <input disabled type="text" name="evidence" id="evidence" placeholder="Narrative Reports (N), Reflection Paper (R), Photo/Video (P/V), Certification (C), Others" class="input-field"><br><br>
                ...
                <div class="footer">
                    ...
                    <input disabled type="text" id="studentSignature" class="input-field"><br><br>
